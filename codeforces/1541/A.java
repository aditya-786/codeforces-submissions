...
public class Main {
    ...
    static void run() {
        boolean tc = true;
        IkwinderFastIO r = new IkwinderFastIO();
        ...
        try (OutputStream out = new BufferedOutputStream(System.out)) {
            ...
            while (testcases-- > 0) {
                ...
                if ((n&1)==0){
                    for (int i=1;i<=n;i+=2) out.write(((i + 1) + " " + i + " ").getBytes());
                }else{
                    for (int i=1;i<=n-3;i+=2) out.write(((i + 1) + " " + i + " ").getBytes());
                    out.write((n + " ").getBytes());
                    out.write((n - 2 + " ").getBytes());
    ...
    static class IkwinderFastIO {
        ...
        public IkwinderFastIO(String file_name) throws IOException {
