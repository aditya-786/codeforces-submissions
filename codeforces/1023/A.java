    ...
    static void run() {
        ...
        try (OutputStream out = new BufferedOutputStream(System.out)) {
            ...
            while (testcases-- > 0) {
                ...
                StringBuilder sb1 = new StringBuilder(r.word());
                StringBuilder sb2 = new StringBuilder(r.word());

                if (sb1.toString().equals(sb2.toString())) out.write(("YES" + " ").getBytes());
                else {
                    ...
                    if (pos != -1 && sb1.length() - 1 <= sb2.length()) {

                        boolean ff1 = false;
                        ff1 = pos <= Math.min(sb1.length(), sb2.length());
                        ff1 = ff1 && sb1.substring(0, pos).equals(sb2.substring(0, pos));

                        boolean ff2 = false;

                        pos = sb1.length() - 1 - pos;
                        sb1.reverse();
                        sb2.reverse();
                        ff2 = pos <= Math.min(sb1.length(), sb2.length());
                        ff2 = ff2 && sb1.substring(0, pos).equals(sb2.substring(0, pos));

                        if (ff1 && ff2) out.write(("YES" + " ").getBytes());
