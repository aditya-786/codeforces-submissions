        ...
        try {
            ...
            try (OutputStream out = new BufferedOutputStream(System.out)) {
                ...
                while (testcases-- > 0){
                    ...
                    //if (c[0]=='2' && c[n-3]=='0'&& c[n-1]=='0'&&c[n-2]=='2') ff = true;

                    if (s[0] == '2' && s[n-3] == '0' && s[n-1] == '0' && s[n-2] == '2') bool = true;
                    if (s[0] == '2' && s[1] == '0' && s[n-1] == '0' && s[n-2] == '2') bool = true;
                    if (s[0] == '2' && s[1] == '0' && s[2] == '2' && s[n-1] == '0') bool = true;
                    if (s[0] == '2' && s[1] == '0' && s[2] == '2' && s[3] == '0') bool = true;
                    if (s[n-4] == '2' && s[n-3] == '0' && s[n-1] == '0' && s[n-2] == '2') bool = true;

                    if (bool) out.write(("YES" + " ").getBytes());
