        ...
        try (OutputStream out = new BufferedOutputStream(System.out)) {
            ...
            while (testcases-- > 0) {
                ...
                if (a == b) {
                    ...
                    long mul1 = diff * div;
                    long abs1 = Math.abs(a - mul1);

                    long mul2 = diff * (div + 1);
                    long abs2 = Math.abs(a - mul2);

                    long res1 = gcd(a - abs1, b - abs1);
                    long res2 = gcd(a + abs2, b + abs2);

                    if (res1 <= res2) {
                        if (res2 > res1) out.write((res2 + " " + abs2 + " ").getBytes());
                        else out.write((res1 + " " + Math.min(abs1, abs2) + " ").getBytes());
                    } else {
                        out.write((res1 + " " + abs1 + " ").getBytes());
                    }
                }
                out.write(("\n").getBytes());
