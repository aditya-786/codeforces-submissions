...
public class Main {
    ...
    static void seiveOfEratotheins(boolean[] prime, long[] primeNumbers)
    {
        ...
        int k = 0;
        for (int i=2;i<1300001;i++) if (prime[i]) primeNumbers[k++] = i;
    }
            ...
            //try(BufferedWriter out = new BufferedWriter(new OutputStreamWriter(System.out)))
            {
                ...
                while (testcaeses -- > 0)
                {
                    ...
                    else
                    {
                        ...
                        if (sum<(w+1)/2 || al.size()==0) out.write((-1+"\n").getBytes());
                        else
                        {
                            out.write((al.size()+"\n").getBytes());

                            for (Integer integer : al) out.write((integer + " ").getBytes());
