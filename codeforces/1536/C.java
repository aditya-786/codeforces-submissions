            ...
            while (testcases-- > 0) {
                ...
                for (char c : sb.toString().toCharArray()){
                    ...
                    if (count1<=0 || count2<=0){
                        ...
                        out.write((map.get(0.0) + " ").getBytes());
                    }else{
                        long gcd = gcd(count1, count2);
                        long temp1 = count1/gcd;
                        long temp2 = count2/gcd;

                        double res = temp1/(double)temp2;
                        map.put(res, map.getOrDefault(res,0)+1);
                        out.write((map.get(res) + " ").getBytes());
                    }
                }
                out.write(("\n").getBytes());
