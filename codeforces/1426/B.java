            ...
            try(OutputStream out = new BufferedOutputStream(System.out))
            {
                ...
                while (testcases -- > 0)
                {
                    ...
                    for (int i=0;i<n;i++)
                    {
                        ...
                        if (list.size() == 4)
                        if (list.get(1).equals(list.get(2))) ff = true;

                    }

//                    if ((m&1) == 1)
//                    {
//                        if (one >=1 && c>=2) out.write(("YES\n").getBytes());
//                        else out.write(("NO\n").getBytes());
//
//                    }
//                    else
//                    {
//                        if (c>=2) out.write(("YES\n").getBytes());
//                        else out.write(("NO\n").getBytes());
//                    }

                    if ((m&1) == 1) out.write(("NO\n").getBytes());
//                    else if (m == 2)
//                    {
//                        if (hs.size() == 1) out.write(("YES\n").getBytes());
//                        else if (n>=2) out.write(("YES\n").getBytes());
//                        else out.write(("NO\n").getBytes());
//                    }
//                    else
//                    {
//                        if (hs.size() == 1) out.write(("YES\n").getBytes());
//                        else if (n>=3) out.write(("YES\n").getBytes());
//                        else out.write(("NO\n").getBytes());
//                    }
                    else
                    {
