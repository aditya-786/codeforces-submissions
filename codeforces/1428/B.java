        ...
        try
        {
            ...
            try (OutputStream out = new BufferedOutputStream(System.out))
            {
                ...
                while (testcases -- > 0)
                {
                    ...
                    //means snake from every room can go clockwise and come back again
                    if (clockwise == 0) out.write((n+"\n").getBytes());
                    //means snake from every room can go anticlockwise and come back again
                    else if (antiClockwise == 0) out.write((n+"\n").getBytes());
                    
                    // both clockwise and anticlockwise present, so where there is off to adjacent, count those only.
                    else
                    {
                        int count = 0;
                        ...
                        if (s.charAt(n-1) == '-' || s.charAt(0) == '-') count++;

                        //if (s.charAt(n-2) == '-' || s.charAt(0) == '-') count++;
