    ...
    static void run(){
        ...
        try (OutputStream out = new BufferedOutputStream(System.out)) {
            ...
            here : while (testcases --> 0){
                ...
                List<Integer> indexes = IntStream.range(0, sb.length()).filter(i -> sb.charAt(i) == 'T').boxed().collect(Collectors.toList());
                ...
                if (indexes.size()!=0) ff = true;
                out.write(res == 1 && !ff ? ("YES" + " ").getBytes() : ("NO" + " ").getBytes());
                out.write(("\n").getBytes());
