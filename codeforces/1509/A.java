...
public class Main {
    ...
    // for global initializations

    // global initialisations end here
        ...
        try (OutputStream out = new BufferedOutputStream(System.out)) {
            ...
            here : while (testcases --> 0){
                ...
                for (int i=0;i<n;i++){
                    ...
                    if ((ele&1)==1) odd.add(ele);
                    else even.add(ele);
                }

//                int extra = -1;
//                if ((even.size()&1)==0){
//                    for (int i : even) out.write((i + " ").getBytes());
//                }else{
//                    for (int i=0;i<even.size()-1;i++) out.write((even.get(i) + " ").getBytes());
//
//                    extra = even.get(even.size()-1);
//                }

//                int oExtra = -1;
//                if ((odd.size()&1)==0){
//                    for (int i : odd) out.write((i + " ").getBytes());
//                }else{
//                    for (int i=0;i<odd.size()-1;i++){
//                        out.write((odd.get(i) + " ").getBytes());
//                    }
//                    oExtra = odd.get(odd.size()-1);
//                }
//
//                if (extra!=-1) out.write((extra + " ").getBytes());
//                if (oExtra!=-1) out.write((oExtra + " ").getBytes());
