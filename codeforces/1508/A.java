...
public class Main {
    ...
    try (OutputStream out = new BufferedOutputStream(System.out)) {
        ...
        start : while (testcases --> 0) {
            ...
            int N = r.ni() << 1;
            char[] s1 = r.word().toCharArray();
            char[] s2 = r.word().toCharArray();
            char[] s3 = r.word().toCharArray();
            ...
            if (count1 < N) {
                ...
                } while (count1 < N && count2 < N && count3 < N);
            }
            if (count2 != N) {
                if (count3 == N) {
                    count3 = count1;
            ...
            while (count2 < N) sb.append(s2[count2++]);
