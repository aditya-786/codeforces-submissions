        ...
        try
        {
            ...
            try (OutputStream out = new BufferedOutputStream(System.out))
            {
                ...
                while (testcases -- > 0)
                {
                    ...
                    for (int i=0;i<n;i++) list.add(fr.nextLine());
                        ...
                        for (int j=0;j<m;j++)
                        {
                            ...
                            if (c == '1')
                            {
                                if (i!=n-1 && j!=m-1)
                                {
                                    ...
                                    finalList.get(finalList.size()-1).add(j);
                                    finalList.get(finalList.size()-1).add(i+1);
                                    finalList.get(finalList.size()-1).add(j);
                                    finalList.get(finalList.size()-1).add(i+1);
                                    finalList.get(finalList.size()-1).add(j+1);
                    ...
                    for (int i=0;i<len;i++)
                    {
                        for (int j=0;j<6;j++)
                        {
                            int ans = finalList.get(i).get(j)+1;
