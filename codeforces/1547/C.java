    ...
    static void run() {
        ...
        try (OutputStream out = new BufferedOutputStream(System.out)) {
            ...
            while (testcases-- > 0) {
                ...
                if (ans.size()!=(n+m)) out.write((-1 + " ").getBytes());
                else {
                    for (int ele : ans) out.write((ele + " ").getBytes());
                }
                out.write(("\n").getBytes());
            }
            // Solution Ends Here
