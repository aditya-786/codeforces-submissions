                ...
                while (testcases-- > 0){
                    ...
                    for (int i=0;i<n;i++) 
                    {
                        for (int j=0;j<m;j++)
                        {
                            if (j-1>=0)
                            {
                                myArray2[i][j] = myArray2[i][j-1];
                            }

                            myArray2[i][j]++;

                            if (arr[i][j]!='*') myArray2[i][j] = 0;
                        }

                        for (int j=m-1;j>=0;j--)
                        {
                            if (j+1<m)myArray1[i][j]=myArray1[i][j+1];
                            myArray1[i][j]++;

                            if (arr[i][j]!='*')myArray1[i][j] = 0;
                        }
                    }
                    ...
                    for (int i=0;i<n;i++)
                    {
                        for (int j=0;j<m;j++)
                        {
                            for (int k=i;k<n;k++)
                            {
                                if (myArray2[k][j]>=k-i+1 && myArray1[k][j]>=k-i+1) count++;
                                else break;
                            }
                        }
                    }
